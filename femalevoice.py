...
def speak(text):
    ...
    for voice in voices:
        if 'female' in voice.name.lower() or 'zira' in voice.name.lower():  # 'zira' is a common female voice in Windows
...
def greet_user():
    speak("Hi boss, I am Jarvis. How can I assist you today?")
